...
case 'setSchedule':
	...
	// clear apc
	if (APCU_ENABLED) apcu_delete('noipfraud-'.$_GET['clids']);
...
function recurseDirs($main, $count, &$t){
    ...
    while($file = readdir($dirHandle)){
		if ($file != '.' && $file != '..') { 
			if(is_dir($main.$file."/")){
				...
				$t['children'][] = array(
					'id' =>    $utf8_string = mb_convert_encoding($file, 'UTF-8', 'ISO-8859-1'),
					'name' =>    $utf8_string = mb_convert_encoding($file, 'UTF-8', 'ISO-8859-1'),
					'type' => 'folder'
				);
